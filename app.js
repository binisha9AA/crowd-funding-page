...
function isBookmarkedLocal(isBookmarked) {
  ...
  if (isBookmarked) {
    imgEl.src =
      "https://raw.githubusercontent.com/Dinesh1042/Frontend-Mentor-Challenges/04414aa7c5ed080bcaec17d68d8b1964b7ec3a18/crowdfunding-product-page-main/images/icon-bookmarked.svg";
    para.innerHTML = `Bookmarked`;
    bookmarkBtnEl.style.background = `hsla(176, 50%, 47%, 0.116)`;
    para.style.color = `#157a74`;
  } else {
    imgEl.src =
      "https://raw.githubusercontent.com/Dinesh1042/Frontend-Mentor-Challenges/04414aa7c5ed080bcaec17d68d8b1964b7ec3a18/crowdfunding-product-page-main/images/icon-bookmark.svg";
...
function successPopup() {
  ...
  imgEl.src = `https://raw.githubusercontent.com/Dinesh1042/Frontend-Mentor-Challenges/04414aa7c5ed080bcaec17d68d8b1964b7ec3a18/crowdfunding-product-page-main/images/icon-check.svg`;
